...
# Source root for child subprocess (FNOS: package not pip-installed).
_PACKAGE_ROOT = Path(__file__).resolve().parent.parent  # cmcc_cloud_alive/
_SRC_ROOT = str(_PACKAGE_ROOT.parent)
...
class SubprocessBackend:
    ...
    def _child_env(self) -> Dict[str, str]:
        ...
        # HARD_GATE#870: drop inherited PYTHONPATH, then re-add src root so
        # FNOS (no pip install) can find "cmcc_cloud_alive" via -m.
